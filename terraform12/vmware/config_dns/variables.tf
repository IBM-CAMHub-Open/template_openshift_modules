...
variable "action" {
  default     = ""
  type        = string
  description = "Indicates the configuration action to be taken (setup, addMaster, addWorker)"
}

variable "domain_name" {
  default     = ""
  type        = string
  description = "Name of the base domain for the cluster"
}
...
variable "node_ips" {
  default     = ""
  type        = string
  description = "Comma separated IP address(es) of the node(s) within the cluster"
}

variable "node_names" {
  default     = ""
  type        = string
  description = "Comma separated Name(s) of the node(s) within the cluster"
}

variable "dhcp_interface" {
  default     = ""
  type        = string
  description = "Name of the interface used to handle DHCP requests"
}

variable "dhcp_router_ip" {
  default     = ""
  type        = string
  description = "IP address for the DHCP router configuration"
}
